        ...
        <div className={`${styles.container} ${styles.headerContent}`}>
          <div className={styles.headerInner}>
            <div className={styles.logoWrapper}>
              <img src="/newIcon.png" alt="Citadel Logo" className={styles.logoImage} />
              <div>
      ...
      <footer className={styles.footer}>
        <div className={styles.container}>
          <div className={styles.footerInner}>
            <div className={styles.footerText}>CITADEL &copy; 2026</div>
            <div className={styles.footerLinks}>
              <Link href="/terms" className={styles.footerLink}>Terms of Service</Link>
              <a href="https://github.com/CitadelProtocol/citadel-core" target="_blank" rel="noopener noreferrer" className={styles.footerIcon}>
                Docs
